...
def test_bc3d_command(tmp_png, mocker):
    ...
    mocker.patch("src.main.visualize_box_counting_3d",
                 return_value=MagicMock())
    mocker.patch("src.main.png_to_3d", return_value=np.ones(
        (32, 32, 8), dtype=bool))
...
def test_td2d_command(tmp_png, mocker):
    ...
    mocker.patch("src.main.visualize_delaunay", return_value=MagicMock())
    mocker.patch("src.main.png_to_2d",
                 return_value=np.ones((32, 32), dtype=bool))
...
def test_kc2d_routes_to_demo(mocker):
    ...
    mock_run = mocker.patch("src.main.run_2d_demo")
...
def test_ms3d_routes_to_demo(mocker):
    ...
    mock_run = mocker.patch("src.main.run_3d_demo")
